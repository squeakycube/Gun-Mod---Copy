...
;			EntityParent dp\cam,fr\Forest_Pivot
		...
		Case "lockroom"
			...
			r\Objects[0] = LoadAnimMesh_Strict("GFX\map\tree.b3d")
			ScaleEntity(r\Objects[0], 0.3, 0.3, 0.3, True)
			EntityParent(r\Objects[0], r\obj)
			TurnEntity r\Objects[0],0,180,0,True
			If Rand(10) = 1 Then
			it = CreateItem("Wrapped Gift", "gift", r\x - 300.0*RoomScale, +100.0*RoomScale, r\z + 300.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x - 300.0*RoomScale, +100.0*RoomScale, r\z + 300.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x - 300.0*RoomScale, +100.0*RoomScale, r\z + 300.0*RoomScale)
				EntityParent(it\collider, r\obj)
				
				PositionEntity (r\Objects[0], r\x - 300.0*RoomScale, +100.0*RoomScale, r\z +300.0*RoomScale, True)
			EndIf
			
			If Rand(5) = 1 Then
				it = CreateItem("Level 2 Key Card", "key2", r\x - 300 * RoomScale, r\y +100.0 * RoomScale, r\z + 300.0 * RoomScale)
				EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 35.0, 0)
			EndIf
		...
		Case "gatea"
			...
			;r\RoomDoors[2] = CreateDoor(r\zone, r\x - 4064.0 * RoomScale, r\y-1280.0*RoomScale, r\z + 3952.0 * RoomScale, 0, r, True)
			;r\RoomDoors[2]\AutoClose = False : r\RoomDoors[2]\open = False
			
			;d.Doors = CreateDoor(r\zone, r\x + 280.0 * RoomScale, 512.0 * RoomScale, r\z - 607.0 * RoomScale, 90, r, False, False)
			
			;r\RoomDoors[2] = CreateDoor(r\zone, r\x - 4064.0 * RoomScale, r\y-1280.0*RoomScale, r\z + 3952.0 r, False, False, 0)
			
			
			;			r\RoomDoors[0] = CreateDoor(0, r\x,2048*RoomScale,r\z+32.0-1024*RoomScale,0,r,False)
			
			
			;r\RoomDoors[2] = CreateDoor(0, r\x - 4064.0 * RoomScale, r\y-1280.0*RoomScale, r\z + 3952.0 * RoomScale, 0, r, True)
			;r\RoomDoors[2]\AutoClose = True : r\RoomDoors[2]\open = False
			;PositionEntity(d\buttons[1], r\x + 1.0 * RoomScale, -650*RoomScale, r\z + 918.0 * RoomScale, True)
			
			;d = CreateDoor(2, r\x - 4064.0 * RoomScale, r\y-1280.0*RoomScale, r\z + 3952.0 * RoomScale, 2, r, False,True, 4)
			d = CreateDoor(0, r\x - 4064.0 * RoomScale, r\y-1280.0*RoomScale, r\z + 3952.0 * RoomScale, 0, r, False, False, 3)
			;CreateDoor(0, r\x + 48.0*RoomScale, 0, r\z - 128.0 * RoomScale, 0, r, False, False, 3)
			d\dir = 3 : d\AutoClose = False : d\open = False
			PositionEntity(d\buttons[1], r\x - 4064.0 * RoomScale, r\y-1280.0*RoomScale, r\z + 3952.0 * RoomScale, True)
	...
	;		For r2.Rooms = Each Rooms
		...
		;	EntityAlpha r\Objects[3],0.0
			...
			r\Objects[3] = LoadAnimMesh_Strict("GFX\map\tree.b3d")
			ScaleEntity(r\Objects[3], 0.3, 0.3, 0.3, True)
			EntityParent(r\Objects[3], r\obj)
			TurnEntity r\Objects[3],0,180,0,True
			If Rand(10) = 1 Then
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, + 400.0*RoomScale, r\z + 10.0*RoomScale)
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, + 400.0*RoomScale, r\z + 10.0*RoomScale)
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, + 400.0*RoomScale, r\z + 10.0*RoomScale)
				EntityParent(it\collider, r\obj)
				
				PositionEntity (r\Objects[3], r\x + 0.0*RoomScale, + 0.0*RoomScale, r\z + 10.0*RoomScale, True)
			EndIf
			;[End Block]
		Case "room079"
			;[Block]
			...
			TurnEntity r\Objects[3],0,180,0,True
			If Rand(10) = 1 Then
			it = CreateItem("Wrapped Gift", "gift", r\x + 10.0*RoomScale, + 400.0*RoomScale, r\z + 570.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x + 10.0*RoomScale, + 400.0*RoomScale, r\z + 670.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x + 50.0*RoomScale, + 400.0*RoomScale, r\z + 670.0*RoomScale)
			EntityParent(it\collider, r\obj)
...
;			
		...
		Case "room513"
			...
			it = CreateItem("Level 2 Key Card", "key2", r\x - 530.0 * RoomScale, 254.0*RoomScale, r\z - 176.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			;[End Block]
		Case "room966"
			;[Block]
		...
		Case "room2_2"
			...
			it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, + 400.0*RoomScale, r\z + 10.0*RoomScale)
				...
				PositionEntity (r\Objects[3], r\x + 0.0*RoomScale, + 0.0*RoomScale, r\z + 0.0*RoomScale, True)
			EndIf
			;[End Block]
		Case "room012"
			;[Block]
			...
			r\Objects[5] = LoadAnimMesh_Strict("GFX\map\tree.b3d")
			ScaleEntity(r\Objects[5], 0.3, 0.3, 0.3, True)
			EntityParent(r\Objects[5], r\obj)
			TurnEntity r\Objects[5],0,180,0,True
			If Rand(10) = 1 Then
			it = CreateItem("Wrapped Gift", "gift", r\x - 584.0*RoomScale, -700.0*RoomScale, r\z - 840.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x - 584.0*RoomScale, -600.0*RoomScale, r\z - 840.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x - 584.0*RoomScale, -500.0*RoomScale, r\z - 840.0*RoomScale)
				EntityParent(it\collider, r\obj)
				
				PositionEntity (r\Objects[5], r\x - 584.0*RoomScale, -770.0*RoomScale, r\z - 840.0*RoomScale, True)
			EndIf
...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "start"
			...
			de.Decals = CreateDecal(0, r\x + 1546.0 * RoomScale, 0.005, r\z + 262.0 * RoomScale, 90, Rand(360), 0)
			EntityParent(de\obj, r\obj)
			
			;de.Decals = CreateDecal(0, r\x + 272.0 * RoomScale, r\y + 810.0 * RoomScale, r\z + 320.0 * RoomScale, 90, Rand(360), 0)
			;EntityParent(de\obj, r\obj)
			...
			it = CreateItem("USP Tactical", "usp", r\x + 1546.0 * RoomScale, r\y + 810.0 * RoomScale, r\z + 320.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 235.0, 0)
			
			it = CreateItem("FN P90", "p90", r\x + 846.0 * RoomScale, r\y + 210.0 * RoomScale, r\z + 320.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 235.0, 0)
			
			If Rand(5) = 1 Then
			it = CreateItem("Level 2 Key Card", "key2", r\x + 250.0 * RoomScale, r\y + 210.0 * RoomScale, r\z - 640.0 * RoomScale)
			EntityParent(it\collider, r\obj) : RotateEntity(it\collider, 0, 35.0, 0)
		EndIf
		...
		Case "endroom"
			...
			r\Objects[15] = LoadAnimMesh_Strict("GFX\map\tree.b3d")
			ScaleEntity(r\Objects[15], 0.3, 0.3, 0.3, True)
			EntityParent(r\Objects[15], r\obj)
			TurnEntity r\Objects[15],0,180,0,True
			If Rand(10) = 1 Then
			it = CreateItem("Wrapped Gift", "gift", r\x + 500.0*RoomScale, +100.0*RoomScale, r\z + 450.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x + 500.0*RoomScale, +100.0*RoomScale, r\z + 450.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x + 500.0*RoomScale, +100.0*RoomScale, r\z + 450.0*RoomScale)
				EntityParent(it\collider, r\obj)
				
				PositionEntity (r\Objects[15], r\x + 500.0*RoomScale, -0.0*RoomScale, r\z + 450.0*RoomScale, True)
			EndIf
		...
		Case "lcz_armory"
			...
			it = CreateItem("FN P90", "p90", r\x - 16.0 * RoomScale, r\y + 0.0 * RoomScale, r\z - -835.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "173"
			...
			;CreateItem("FN P90", "p90", r\x-(2914+1024)*RoomScale, 170.0*RoomScale, r\z+40*RoomScale)
			
			;CreateItem("FN P90", "p90", r\x-(4048.0)*RoomScale, 30.0*RoomScale, r\z+1232.0*RoomScale)
		...
		Case "room1archive"
			...
			If Rand(10) = 1 Then
				...
				PositionEntity (r\Objects[0], r\x - 300.0*RoomScale, -0.0*RoomScale, r\z + 300.0*RoomScale, True)
			EndIf
		...
		Case "room2_3","room3_3"
			...
			TurnEntity r\Objects[0],0,180,0,True
			If Rand(10) = 1 Then
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, +100.0*RoomScale, r\z - 0.0*RoomScale)
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, +100.0*RoomScale, r\z - 0.0*RoomScale)
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, +100.0*RoomScale, r\z - 0.0*RoomScale)
				EntityParent(it\collider, r\obj)
				
				PositionEntity (r\Objects[0], r\x + 0.0*RoomScale, + 0.0*RoomScale, r\z - 0.0*RoomScale, True)
			EndIf
			;[End Block]
		...
		Case "room1162"
			...
			r\Objects[1] = LoadAnimMesh_Strict("GFX\map\tree.b3d")
			ScaleEntity(r\Objects[1], 0.3, 0.3, 0.3, True)
			EntityParent(r\Objects[1], r\obj)
			TurnEntity r\Objects[1],0,180,0,True
			If Rand(10) = 1 Then
			it = CreateItem("Wrapped Gift", "gift", r\x + 500.0*RoomScale, +100.0*RoomScale, r\z - 450.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x + 500.0*RoomScale, +100.0*RoomScale, r\z - 450.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x + 500.0*RoomScale, +100.0*RoomScale, r\z - 450.0*RoomScale)
				...
				PositionEntity (r\Objects[1], r\x + 500.0*RoomScale, -0.0*RoomScale, r\z - 450.0*RoomScale, True)
			EndIf
...
;			RotateEntity r\Objects[21],8.6,-150.0,-5.0
		...
		Case "room2_4"
			...
			r\Objects[10] = LoadAnimMesh_Strict("GFX\map\tree.b3d")
			ScaleEntity(r\Objects[10], 0.3, 0.3, 0.3, True)
			EntityParent(r\Objects[10], r\obj)
			TurnEntity r\Objects[10],0,180,0,True
			If Rand(10) = 1 Then
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, + 400.0*RoomScale, r\z + 10.0*RoomScale)
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, + 400.0*RoomScale, r\z + 10.0*RoomScale)
				it = CreateItem("Wrapped Gift", "gift", r\x + 0.0*RoomScale, + 400.0*RoomScale, r\z + 10.0*RoomScale)
				...
				PositionEntity (r\Objects[10], r\x + 0.0*RoomScale, + 0.0*RoomScale, r\z + 0.0*RoomScale, True)
			EndIf
			;[End Block]
			;[End Block]
		Case "room3z2"
		...
		Case "medibay"
			...
			r\Objects[4] = LoadAnimMesh_Strict("GFX\map\tree.b3d")
			ScaleEntity(r\Objects[4], 0.3, 0.3, 0.3, True)
			EntityParent(r\Objects[4], r\obj)
			TurnEntity r\Objects[4],0,180,0,True
			If Rand(10) = 1 Then
			it = CreateItem("Wrapped Gift", "gift", r\x - 800.0*RoomScale, +100.0*RoomScale, r\z + 650.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x - 800.0*RoomScale, +100.0*RoomScale, r\z + 650.0*RoomScale)
			it = CreateItem("Wrapped Gift", "gift", r\x - 800.0*RoomScale, +100.0*RoomScale, r\z + 650.0*RoomScale)
				EntityParent(it\collider, r\obj)
				
				PositionEntity (r\Objects[4], r\x - 800.0*RoomScale, -0.0*RoomScale, r\z + 650.0*RoomScale, True)
			EndIf
...
Function CreateSecurityCam.SecurityCams(x#, y#, z#, r.Rooms, screen% = False)
	...
	If screen Then
		...
		CameraRange sc\Cam, 0.01,8.0 ;6.0
