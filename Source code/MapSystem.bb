...
;			PositionEntity(r\Objects[6], r\x - 848*RoomScale, 0.5, r\z-576*RoomScale, True)
		...
		Case "room2offices"
			...
			it = CreateItem("Level 1 Key Card", "key1", r\x - 156.0 * RoomScale, r\y + 151.0 * RoomScale, r\z + 72.0 * RoomScale)
			EntityParent(it\collider, r\obj)
			...
			it = CreateItem("Mastercard", "misc", r\x + 396.0 * RoomScale, r\y + 151.0 * RoomScale, r\z + 72.0 * RoomScale)
			EntityParent(it\collider, r\obj)
		...
		Case "start"
			...
			r\Objects[8] = CreatePivot()
			PositionEntity (r\Objects[8], EntityX(r\obj) - 1000.0 * RoomScale, + 960.0 * RoomScale, EntityZ(r\obj) - 572.0 * RoomScale)
			;PositionEntity (r\Objects[8], EntityX(r\obj) - 1200.0 * RoomScale, EntityY(r\obj) + 3960.0 * RoomScale, EntityZ(r\obj) + 1672.0 * RoomScale)
			;PositionEntity (r\Objects[8], EntityX(r\obj) - 500.0 * RoomScale, EntityY(r\obj) + 1200.0 * RoomScale, EntityZ(r\obj) + 60.0 * RoomScale)
			
			For i = 2 To 7
				EntityParent(r\Objects[i], r\obj)
			Next
			
			it = CreateItem("USP Tactical", "usp", r\x + 1706.0 * RoomScale, r\y + 810.0 * RoomScale, r\z + 320.0 * RoomScale)
			...
			;If Rand(5) = 1 Then
				it = CreateItem("Level 1 Key Card", "key1", r\x + 250.0 * RoomScale, r\y + 210.0 * RoomScale, r\z - 640.0 * RoomScale)
