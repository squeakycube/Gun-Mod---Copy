						...
						If Rand(15)=1 Then 
							Select Rand(13)
								...
								Case 7
									RandomSeed = "die"
								Case 8
									RandomSeed = "squeakyWantsToDieWhileCoding"
								Case 9
		...
		Select MainMenuTab
			...
			Case 3,5,6,7 ;options
				...
				ElseIf MainMenuTab = 7 ;Advanced
					...
					Color 255,255,255
					AAText(x + 20 * MenuScale, y, "Descriptions and advanced item names")
					ConsoleOpening = DrawTick(x + 310 * MenuScale, y + MenuScale, ConsoleOpening)
					If MouseOn(x+310*MenuScale,y+MenuScale,20*MenuScale,20*MenuScale)
...
Function DrawOptionsTooltip(x%,y%,width%,height%,option$,value#=0,ingame%=False)
	...
	Select Lower(option$)
		...
		Case "itemnames"
			txt = "Shows item names above items and shows descritions in inventory."
		Case "achpopup"
